...
func autoGenConfig(cb application.ConfigBuilder) error {
	...
	// component: com0-testcmds0x82bca1.TestReadObjects
	cominfobuilder.Next()
	cominfobuilder.ID("com0-testcmds0x82bca1.TestReadObjects").Class("cli-handler-registry").Aliases("").Scope("")
	...
	// component: com1-testcmds0x82bca1.TestReadPackIdx
	cominfobuilder.Next()
	cominfobuilder.ID("com1-testcmds0x82bca1.TestReadPackIdx").Class("cli-handler-registry").Aliases("").Scope("")
	...
	// component: com2-demo0x52dcb1.TestPoint
	cominfobuilder.Next()
	cominfobuilder.ID("com2-demo0x52dcb1.TestPoint").Class("life").Aliases("").Scope("")
...
// comFactory4pComTestReadObjects : the factory of component: com0-testcmds0x82bca1.TestReadObjects
...
func (inst * comFactory4pComTestReadObjects) getterForFieldLASelector (context application.InstanceContext) store0x8467b3.LibAgent {
	...
	if !ok {
		...
		eb.Message("bad cast")
		eb.Set("com", "com0-testcmds0x82bca1.TestReadObjects")
		eb.Set("field", "LA")
		eb.Set("type1", "?")
...
// comFactory4pComTestReadPackIdx : the factory of component: com1-testcmds0x82bca1.TestReadPackIdx
...
func (inst * comFactory4pComTestReadPackIdx) getterForFieldLASelector (context application.InstanceContext) store0x8467b3.LibAgent {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com1-testcmds0x82bca1.TestReadPackIdx")
		eb.Set("field", "LA")
		eb.Set("type1", "?")
		eb.Set("type2", "store0x8467b3.LibAgent")
		context.HandleError(eb.Create())
...
// comFactory4pComTestPoint : the factory of component: com2-demo0x52dcb1.TestPoint
...
func (inst * comFactory4pComTestPoint) getterForFieldAgentSelector (context application.InstanceContext) store0x8467b3.LibAgent {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com2-demo0x52dcb1.TestPoint")
		eb.Set("field", "Agent")
		eb.Set("type1", "?")
		eb.Set("type2", "store0x8467b3.LibAgent")
		context.HandleError(eb.Create())
