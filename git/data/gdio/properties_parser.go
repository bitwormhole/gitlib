...
func ParseProperties(text string, container *dxo.Properties) (*dxo.Properties, error) {

	if container == nil {
		container = &dxo.Properties{}
	}
...
func (inst *simplePropertiesParser) handleKeyValue(line string) error {
	...
	inst.output.Set(inst.keyPrefix+key, val)
	return nil
}
