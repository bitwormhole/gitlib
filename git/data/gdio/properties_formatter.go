...
func FormatProperties(tab *dxo.Properties) string {
...
func FormatPropertiesWithSegment(tab *dxo.Properties) string {
	formatter := &simplePropertiesFormatter{}
...
func (inst *simplePropertiesFormatter) handleProps(props *dxo.Properties) {
