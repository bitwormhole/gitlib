...
func (inst *simpleConfig) _Impl() (repositories.Config, repositories.Config) {
	return inst, inst
}

func (inst *simpleConfig) NodeType() repositories.NodeType {
	return repositories.NodeConfig
}

func (inst *simpleConfig) init(p *repositories.ConfigChainParams) {
